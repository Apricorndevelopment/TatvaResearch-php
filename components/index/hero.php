...
<section class="ve to a particular section andoverflow hidden hide anythig which goes outside the video -->
    <div class="absolute inset-0">
        ...
        <div class="absolute inset-0 hero-overlay-custom opacity-90"></div>
...
border border-white/20 rounded-full backdrop-blur-md shadow-lg float-animation">
    ...
    Data-Driven Market Intelligence for Smarter Business Decisions
            ...
            <!-- CTA group with impact -->
            <div class="flex flex-wrap justify-center gap-5 mb-14">
                <button class="bg-gradient-to-r from-blue-600 to-indigo-600 px-8 py-4 rounded-full text-white font-bold text-base shadow-2xl hover:scale-105 transition transform hover:shadow-blue-500/30 flex items-center gap-2">
                    <i class="fas fa-chart-simple"></i> Explore intelligence suite
                </button>
                <button class="bg-white/10 backdrop-blur-md border border-white/30 px-8 py-4 rounded-full text-white font-semibold hover:bg-white/20 transition flex items-center gap-2 shadow-xl">
                    <i class="fas fa-shield-alt"></i> Consumer rights hub
                </button>
            </div>
            ...
            <div class="flex flex-wrap justify-center gap-3 text-sm font-medium">
                ...
                <div class="insight-chip px-5 py-3 rounded-full backdrop-blur-md text-white flex items-center gap-2 shadow-lg lg:hidden xl:flex">
                    <i class="fas fa-database text-green-200"></i> 📈 360° data fusion
                </div>
            </div>
        </div>
    </div>
