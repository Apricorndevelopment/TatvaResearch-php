    ...
    <section class="py-20 md:py-28 bg-white dark:bg-gray-950 relative overflow-hidden">
        ...
        <div class="container mx-auto px-4 relative z-10">
            <div class="text-center max-w-3xl mx-auto mb-16">
                <span class="inline-block text-sm font-semibold tracking-wider text-blue-600 uppercase bg-blue-50 dark:bg-blue-950/30 px-4 py-1.5 rounded-full mb-5">why choose us</span>
                <h2 class="text-4xl md:text-5xl font-bold text-gray-900 dark:text-white tracking-tight mb-5">Main features</h2>
                <p class="text-lg text-gray-500 dark:text-gray-400 leading-relaxed">Transform raw consumer data into actionable insights using AI-powered analytics, real-time tracking, and ethical research frameworks.</p>
            </div>
